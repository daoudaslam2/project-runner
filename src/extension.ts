...
export function activate(context: vscode.ExtensionContext) {
	...
	const configChange = vscode.workspace.onDidChangeConfiguration((event) => {
		if (event.affectsConfiguration('projectRunner.showStatusBarButton')) {
...
function updateStatusBar(statusBarItem: vscode.StatusBarItem): void {
	const showStatusBarButton = vscode.workspace.getConfiguration('projectRunner').get('showStatusBarButton', true);
